...
function usage() {
  ...
  console.error("");
  console.error("FLOW FILE FORMAT");
  console.error("");
  console.error("    name='My Flow'");
  console.error("");
  console.error("    [env]");
  console.error("    ENV_VAR=value");
  console.error("");
  console.error("    [steps.step1]");
  console.error("    cmd = 'echo hello'           # Command to run");
  console.error("    deps = ['step2']             # List of dependencies (optional)");
  ...
  console.error("NOTES");
  console.error("");
  console.error(`    ${APP_NAME} stores state information and logs in the ${STATE_DIR_NAME} folder.`);
  console.error("");
  Deno.exit(1);
}
